<template>
  ...
  >
    ...
    >
      <div
        :class="['swiper-el-block', { active: subSlide.active }]"
        class="slider_con_el"
      >
  ...
  <div class="shop">
    <div class="shop_filter">
      ...
      <div class="shop_filter_adres">
        ...
        <input
          class="shop_filter_text"
          type="text"
          placeholder="Все регионы, радиус"
          v-model="region"
        />
      </div>
            ...
            <div class="product">
              ...
              <div class="product_des">
                <div class="product_title">
                  <div>{{ prod.Title }}</div>
                  <img
                    v-if="favorite.find((prodFav) => prodFav.Ad_id == prod.Id) != undefined"
                    @click="clickFavorite(prod)"
...
export default {
  data() {
    return {
      ...
      sldiers: [
        ...
        {
          /* Нет фото */ path: require("@/assets/slider3.png"),
  ...
  async created() {
    ...
    try {
      console.log("http://185.112.83.36:8080/sortProductListHourlyRate");
