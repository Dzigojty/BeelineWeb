    ...
    <div class="shop_product">
      ...
      <div v-for="(favorite, index) in favorites" :key="index" class="shop_list">
        <a @click="selectProduct(favorite)" class="route-view">
          <div class="product">
            <img class="product_img" :src="favorite.Avatar !== '../assets/product2.png' ? `data:image/png;base64,${favorite.Avatar}` : require('@/assets/product2.png')" alt="" />
...
const apiClient = axios.create({
  baseURL: 'http://localhost:8080', // Ваш API URL
